def run(qc):
    ...
    num_qubits = 8
    states_to_amplify = [12, 12, 12, 39, 53, 42, 33, 53, 16, 59, 26, 28, 36, 24, 40, 38, 56, 60, 23, 33, 51, 40, 47, 16, 35, 51, 33, 43, 2, 58, 6, 13, 10, 9, 11, 11, 27, 20, 10, 32, 13, 58]
    num_iterations = 2
    main_quito( num_qubits, states_to_amplify, num_iterations, qc )

    # measurement basis i,i,h,h,i,h,i,i
    qc.h(2)
    qc.h(3)
    qc.h(5)
