def run(qc):
    ...
    num_qubits = 9
    states_to_amplify = [31, 17, 113, 75, 85, 3, 36, 6, 117, 62, 66, 90, 70, 120, 22, 37, 36, 49, 75, 110, 102, 11, 125, 60, 88, 117, 88, 57, 119, 82, 74, 124]
    num_iterations = 2
    main_quito( num_qubits, states_to_amplify, num_iterations, qc )

    # measurement basis h,i,i,h,i,i,h,i,i
    qc.h(0)
    qc.h(3)
    qc.h(6)
