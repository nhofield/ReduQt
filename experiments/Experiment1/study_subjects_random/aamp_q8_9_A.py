def run(qc):
    ...
    num_qubits = 8
    states_to_amplify = [31, 55, 36, 17, 15, 58, 59, 33, 4, 40, 10, 21, 40, 40, 9, 43, 26, 9, 60, 7, 16, 27, 14, 3, 29, 11, 59, 33, 55, 54, 59, 13, 60, 28, 60, 14, 0, 36, 8, 49, 50, 40, 43, 47, 16, 12, 39]
    num_iterations = 2
    main_quito( num_qubits, states_to_amplify, num_iterations, qc )

    # measurement basis i,i,h,i,h,h,i,i
    qc.h(2)
    qc.h(4)
    qc.h(5)
