def run(qc):
    ...
    num_qubits = 9
    states_to_amplify = [89, 26, 38, 36, 113, 49, 1, 50, 18, 95, 44, 88, 119, 32, 62, 99, 55, 9, 52, 96, 4, 98, 70, 114, 8, 80, 110, 39, 72, 82, 103, 69, 82, 24, 114, 74, 6, 67, 58, 94, 107, 17, 49, 115, 36, 123, 50, 87, 54, 122, 19, 125, 56, 110, 81, 61, 65, 49, 70, 79, 22, 83, 72, 72, 50, 9, 11, 43, 0, 7, 17, 56, 59, 33, 67, 125, 98, 40, 92, 26, 8, 45, 63, 125, 70, 6, 90, 33, 16, 51, 8, 8, 38, 67, 12, 48, 30, 68, 5, 26, 83, 125, 23, 25, 20, 112, 81, 28, 0, 101, 120, 123]
    num_iterations = 2
    main_quito( num_qubits, states_to_amplify, num_iterations, qc )

    # measurement basis i,i,i,h,h,h,h,i,i
    qc.h(3)
    qc.h(4)
    qc.h(5)
    qc.h(6)
