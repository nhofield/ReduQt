def run(qc):
    ...
    num_qubits = 8
    states_to_amplify = [5, 46, 48, 48, 34, 14, 22, 40, 43, 11, 53, 12, 48, 4, 54, 53, 25, 2, 26, 0, 55, 43, 35, 9, 59, 61, 36, 1, 14, 31, 29, 8, 31, 48, 0, 31, 8]
    num_iterations = 2
    main_quito( num_qubits, states_to_amplify, num_iterations, qc )

    # measurement basis i,h,i,i,h,h,i,i
    qc.h(1)
    qc.h(4)
    qc.h(5)
