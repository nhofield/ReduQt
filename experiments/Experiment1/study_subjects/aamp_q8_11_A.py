def run(qc):
    ...
    num_qubits = 8
    states_to_amplify = [47, 40, 46, 42, 25, 32, 47, 7, 22, 16, 61, 52, 28, 49, 43, 11, 0, 47, 37, 32, 60, 14, 54, 16, 42, 49, 35, 4, 51, 4, 59, 14, 3, 28, 44, 10, 28, 55, 50, 1, 4, 50, 1, 28, 47, 7, 57, 52, 16, 11, 4, 21, 36, 5, 14, 2, 37]
    num_iterations = 2
    main_quito( num_qubits, states_to_amplify, num_iterations, qc )

    # measurement basis h,h,i,h,h,i,i,i
    qc.h(0)
    qc.h(1)
    qc.h(3)
    qc.h(4)
